...
#Region "--- Funciones utilizados para inicializar la conexion hacia la base de datos ..."
    ...
    Public Sub BuscarConexionEnXml(ByVal nombrexml As String)
        ...
        Try
            ...
            'dsconexion.ReadXml(System.AppDomain.CurrentDomain.BaseDirectory + "\" & nombrexml)
    ...
    Private Sub AsignarDatosDConexion(ByVal dsconexion As DataSet)
        ...
        _sPassword = Crypto.DesEncriptar(dsconexion.Tables(0).Rows(0)(3))
...
#Region "--- Funciones de los stored Procs"
    ...
    ''' <summary>
    ''' Se llena un datatable utilizando como recurso un stored procedure...
    ''' </summary>
    ''' <param name="_nombreStoredProc"></param>
    ''' <returns></returns>
    ''' <remarks></remarks>
    Public Function LlenarDataTableStoredProc(ByVal _nombreStoredProc As String) As DataTable
    ...
    ''' <summary>
    ''' Se llena un datatable utilizando un stored procedure, pero con parametros...
    ''' </summary>
    ''' <param name="_nombreStoredProc"></param>
    ''' <param name="parametros"></param>
    ''' <returns></returns>
    ''' <remarks></remarks>
    Public Function LlenarDataTableStoredProc(ByVal _nombreStoredProc As String, ByVal ParamArray parametros() As ParametrosStoredP) As DataTable
    ...
    ''' <summary>
    ''' No retorna ningun valor,,, se llena un datatable enviado por referencia utilizando el stored procedure
    ''' especificado.
    ''' </summary>
    ''' <param name="_nombreStoredProc"></param>
    ''' <param name="_dtDatos"></param>
    ''' <remarks></remarks>
    Public Sub LlenarDataTableStoredProc(ByVal _nombreStoredProc As String, _
                                       ByRef _dtDatos As DataTable)
